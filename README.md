...
*Note: The clinical narratives in our benchmark are derived and processed from the [DDXPlus](https://github.com/mila-iqia/ddxplus) dataset. We thank the authors for their open-source contribution.*
